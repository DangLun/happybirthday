const contentLetterSrart_actived = "Chào cô gái tên Trân :> Mở quà đê ->." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc mừng sinh nhật người yêu dễ thương và ngoan hiền dịu nhất quả đất của tôi. Hôm nay 18/07 nó là một ngày bình thường đối với tất cả mọi người nhưng nó là một ngày đặc biệt với em. Chúc em Sinh Nhật Vui vẻ ^^!  Duy Đăng." //Nội dung của bức thư
...
function createLight(a) {
    ...
    const blurLv = [2, 4];
    const count = a;
    const allDefaultColor = ["red", "lime", "yellow", "orange", "blue", "cyan"]
    ...
    for (var i = 0; i < count; i++) {
        ...
        var widthEle = Math.floor(Math.random() * 5) + 5;
